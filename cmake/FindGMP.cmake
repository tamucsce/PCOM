...
find_library(GMP_LIB_STATIC   libgmp.a   HINTS ${PKG_gmp_LIBDIR})
find_library(GMPXX_LIB_STATIC libgmpxx.a HINTS ${PKG_gmpxx_LIBDIR})
#else()
...
mark_as_advanced(
  GMP_INCLUDE_DIR GMP_LIB GMP_LIB_STATIC
  GMPXX_INCLUDE_DIR GMPXX_LIB GMPXX_LIB_STATIC
  )
...
find_package_handle_standard_args(GMP
  ...
  GMPXX_LIB_STATIC GMP_LIB_STATIC
)
...
if(GMP_FOUND)
  ...
  if(NOT TARGET GMP::gmp_static)
	add_library(GMP::gmp_static UNKNOWN IMPORTED)
    set_target_properties(GMP::gmp_static PROPERTIES
      IMPORTED_LOCATION ${GMP_LIB_STATIC}
      INTERFACE_INCLUDE_DIRECTORIES ${GMP_INCLUDE_DIR}
    )
  endif()
  ...
  if(NOT TARGET GMP::gmpxx)
    ...
    if(NOT TARGET GMP::gmpxx_static)
    add_library(GMP::gmpxx_static UNKNOWN IMPORTED)
    set_target_properties(GMP::gmpxx_static PROPERTIES
      IMPORTED_LOCATION ${GMPXX_LIB_STATIC}
      INTERFACE_INCLUDE_DIRECTORIES ${GMPXX_INCLUDE_DIR}
      INTERFACE_LINK_LIBRARIES GMP::gmp_static
    )
  endif()
